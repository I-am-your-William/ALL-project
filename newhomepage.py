...
#Navigation Buttons
#Log Out Button
lgtButton = Button(root,text="Logout",font=("Century Gothic",20),bg="red",borderwidth=1)
...
EventButton = Button(root, image=nb1, borderwidth=0)
...
CldrButton = Button(root, image=nb2, borderwidth=0)
...
CttHpButton = Button(root, image=nb3, borderwidth=0)
